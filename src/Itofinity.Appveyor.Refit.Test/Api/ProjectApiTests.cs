...
namespace Itofinity.Appveyor.Refit.Test
{
    ...
    public class ProjectApiTests
    {
        ...
        private string userAgent = "Itofinity.Appveyor.Refit.Test.ProjectApiTests";
        ...
        /// <summary>
        /// Test GetProjectArtifact
        /// </summary>
        [Test]
        public async void GetProjectArtifactTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountName = null;
            //string projectSlug = null;
            ...
            //bool? all = null;
            //bool? pr = null;
            //var response = await instance.GetProjectArtifact(userAgent, accountName, projectSlug, artifactFileName, branch, tag, job, all, pr);
        ...
        public async void GetProjectDeploymentsTest()
        {
            ...
            //var response = await instance.GetProjectDeployments(userAgent, accountName, projectSlug, recordsNumber);
        ...
        /// </summary>
        [Test]
        public async void GetProjectEnvironmentVariablesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountName = null;
            //string projectSlug = null;
            //var response = await instance.GetProjectEnvironmentVariables(userAgent, accountName, projectSlug);
            //Assert.IsInstanceOf<List<StoredNameValue>> (response, "response is List<StoredNameValue>");
        }
        ...
        /// <summary>
        /// Test UpdateProjectEnvironmentVariables
        /// </summary>
        [Test]
        public async void UpdateProjectEnvironmentVariablesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountName = null;
            //string projectSlug = null;
            //List<StoredNameValue> body = null;
            //instance.UpdateProjectEnvironmentVariables(userAgent, accountName, projectSlug, body);
