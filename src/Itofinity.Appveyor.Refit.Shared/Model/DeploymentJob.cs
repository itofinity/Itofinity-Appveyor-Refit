...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeploymentJob :  IEquatable<DeploymentJob>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentJob" /> class.
        /// </summary>
        ...
        public DeploymentJob(string JobId = default(string), string Name = default(string), Status Status = default(Status), DateTime? Started = default(DateTime?), DateTime? Finished = default(DateTime?), int? MessagesCount = default(int?))
        {
            this.JobId = JobId;
            this.Name = Name;
            this.Status = Status;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeploymentJob);
        }

        /// <summary>
        /// Returns true if DeploymentJob instances are equal
        /// </summary>
        /// <param name="other">Instance of DeploymentJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeploymentJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
