...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeploymentEnvironment :  IEquatable<DeploymentEnvironment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentEnvironment" /> class.
        /// </summary>
        ...
        public DeploymentEnvironment(int? DeploymentEnvironmentId = default(int?), string Name = default(string), DeploymentProviderType Provider = default(DeploymentProviderType), int? AccountId = default(int?), int? ProjectsMode = default(int?), SecurityDescriptor SecurityDescriptor = default(SecurityDescriptor), string Tags = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeploymentEnvironment);
        }

        /// <summary>
        /// Returns true if DeploymentEnvironment instances are equal
        /// </summary>
        /// <param name="other">Instance of DeploymentEnvironment to be compared</param>
        /// <returns>Boolean</returns>
