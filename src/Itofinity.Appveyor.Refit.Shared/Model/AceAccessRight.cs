...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AceAccessRight :  IEquatable<AceAccessRight>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AceAccessRight" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AceAccessRight() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AceAccessRight" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AceAccessRight);
        }

        /// <summary>
        /// Returns true if AceAccessRight instances are equal
        /// </summary>
        /// <param name="other">Instance of AceAccessRight to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AceAccessRight other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
