...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeploymentLookupModel :  IEquatable<DeploymentLookupModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentLookupModel" /> class.
        /// </summary>
        ...
        public DeploymentLookupModel(int? DeploymentId = default(int?), BuildLookupModel Build = default(BuildLookupModel), Status Status = default(Status), DateTime? Started = default(DateTime?), DateTime? Finished = default(DateTime?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeploymentLookupModel);
        }

        /// <summary>
        /// Returns true if DeploymentLookupModel instances are equal
        /// </summary>
        /// <param name="other">Instance of DeploymentLookupModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeploymentLookupModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
