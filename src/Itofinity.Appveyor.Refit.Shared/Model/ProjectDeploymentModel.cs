...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectDeploymentModel :  IEquatable<ProjectDeploymentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDeploymentModel" /> class.
        /// </summary>
        ...
        public ProjectDeploymentModel(int? DeploymentId = default(int?), BuildLookupModel Build = default(BuildLookupModel), Status Status = default(Status), DateTime? Started = default(DateTime?), DateTime? Finished = default(DateTime?), DeploymentEnvironmentLookupModel Environment = default(DeploymentEnvironmentLookupModel))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProjectDeploymentModel);
        }

        /// <summary>
        /// Returns true if ProjectDeploymentModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectDeploymentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectDeploymentModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
