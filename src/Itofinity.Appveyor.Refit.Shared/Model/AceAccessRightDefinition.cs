...
namespace Itofinity.Appveyor.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AceAccessRightDefinition :  IEquatable<AceAccessRightDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AceAccessRightDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AceAccessRightDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AceAccessRightDefinition" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AceAccessRightDefinition {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AceAccessRightDefinition);
        }

        /// <summary>
        /// Returns true if AceAccessRightDefinition instances are equal
        /// </summary>
        /// <param name="other">Instance of AceAccessRightDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AceAccessRightDefinition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
