...
namespace Itofinity.Appveyor.Refit.Api
{
    ...
    public interface IBuildApi
    {
        ...
        System.Threading.Tasks.Task<System.IO.Stream> GetBuildArtifact([Header("UserAgent")] string userAgent, [AliasAs("jobId")]string jobId, [AliasAs("artifactFileName")]string artifactFileName);
        ...
        /// <exception cref="Itofinity.Appveyor.Refit.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobId">Build ID (&#x60;jobId&#x60; property of &#x60;BuildJob&#x60;)</param>
        /// <returns>Task of List&lt;ArtifactModel&gt;</returns>
        [Get("/buildjobs/{jobId}/artifacts")]
        System.Threading.Tasks.Task<List<ArtifactModel>> GetBuildArtifacts([Header("UserAgent")] string userAgent, [AliasAs("jobId")]string jobId);
