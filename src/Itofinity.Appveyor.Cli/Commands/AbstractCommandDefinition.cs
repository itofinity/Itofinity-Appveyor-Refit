...
namespace Itofinity.Appveyor.Cli.Commands
{
    public abstract class AbstractCommandDefinition : ICommandDefinition
    {
        ...
        public IOptionDefinition ApiTokenOptionDefinition => new ApiToken();
        ...
        public int RunRequest(CommandLineApplication command, CommandLineApplication app, Func<object> request)
        {
        ...
        public int RunRequest(CommandLineApplication command, CommandOption logLocationOption, CommandOption logVerbosityOption, CommandOption porcelainOption, CommandOption rawOption,
            Func<object> request)
        {
